...
<head>
    ...
    <link href="./Resources/css/style-partners.css" rel="stylesheet" />
    <style>
        html, body {
            width: 100%;
            min-width: 1200px;
...
<body>
        ...
        <div class="container" style="background-color:#fafbfc">
            <div class="nav">
                <a href="http://www.tndn.co.kr" target="_blank" class="logo">
                    <img src="./Resources/img/favicon-96x96.png" height="30px"></a>
    ...
    <div class="section">
    	<form action="paymentapi.jsp" class="payboxform" method="POST" target="_blank">
    ...
    <footer>
        <div class="footer-wrap">
            <h3><img src="./Resources/img/logo_tndn_light.svg" alt="티엔디엔 로고"></h3>
